...
public class DateTime 
{
	...
	*/
	...
	public static int subtract(DateTime d1,DateTime d2) throws MoreThanOneDayException
	{
		...
		if (!Date.equal(d1.getDate(), d2.getDate()) && (d1.getDate().nextDate() != d2.getDate() || d2.getDate().nextDate() != d1.getDate()))
		    throw new MoreThanOneDayException();
		
		else diff = Time12.subtract(d1.getTime(), d2.getTime());
	 ...
	 * @param  None
	 * @return a string in the format MM/DD/YYYY hh:mm am/pm
	*/
