...
public class Date
{
	...
	*/
	...
	{
	    if (d1.getYear() < d2.getYear()) // easiest case; e.g. 2004 vs 2017
		return true;

	    else if (d1.getYear() == d2.getYear() && d1.getMonth() < d2.getMonth()) // e.g. January 2020 vs April 2020
		return true;

	    else if (d1.getYear() == d2.getYear() && d1.getMonth() == d2.getMonth() && d1.getDay() < d2.getDay()) // e.g. March 7, 2020 vs March 20, 2020
		return true;
